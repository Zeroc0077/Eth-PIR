...
// ReconstructElem Store the database with entries decomposed into Z_p elements, and mapped to [-p/2, p/2]
...
// ApproxSquareDatabaseDims Find smallest l, m such that l*m >= N*ne and ne divides l, where ne is
...
// ApproxDatabaseDims Find smallest l, m such that l*m >= N*ne and ne divides l, where ne is
